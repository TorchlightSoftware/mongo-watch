...
module.exports = ({host, port, dbOpts, username, password, useMasterOplog, authdb, replicaSet}, done) ->
  connect {db: 'local', host, port, dbOpts, username, password, authdb, replicaSet}, (err, oplogClient) =>
